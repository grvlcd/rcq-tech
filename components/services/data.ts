import { LayoutTemplate, Sparkles, Smartphone, Workflow } from "lucide-react";
...
export const services = [
  {
    ...
    featured: true,
    iconClass:
      "max-md:size-[min(58vw,11rem)] size-[min(92vw,18rem)] sm:size-[min(85vw,20rem)] lg:size-[min(100%,22rem)] xl:size-[min(100%,26rem)] text-gold/[0.18] stroke-[0.85] group-hover:text-gold/[0.26]",
  },
  {
    id: "02",
  ...
  },
  {
    ...
    description: "Practical AI integration, from chatbots to smart data tools.",
    icon: Sparkles,
    className: "lg:col-span-5",
  ...
  },
  {
    ...
    iconClass:
      "absolute -bottom-[10%] -right-[6%] size-[min(52%,14rem)] max-md:size-[min(50vw,12rem)]",
  },
] as const;
